...
const App = () => {
  ...
  return (
    <div className='dark:bg-black relative'>
      ...
      {/* Custom Cursor Ring */}
      <div ref={outlineRef} className='fixed top-0 left-0 h-10 w-10 rounded-full border border-primary pointer-events-none z-9999' style={{transition:'transform o.1s ease-out'}}>
      </div>
